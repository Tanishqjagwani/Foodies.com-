...
import { COLORS, icons, images, SIZES, FONTS } from "../constant";
...
export default function Home({ navigation }) {
  ...
  function getCatgoryNameById(id) {
  ...
  function renderMainCatergories() {
    ...
    return (
      ...
      >
        ...
        <Text style={{ ...FONTS.h1, marginHorizontal: 10 }}>Category</Text>
        <FlatList
          data={categories}
          horizontal
              ...
              {item.categories.map((categoryId) => {
                return (
                  <View style={{ flexDirection: "row" }} key={categoryId}>
                    <Text>{getCatgoryNameById(categoryId)}</Text>
